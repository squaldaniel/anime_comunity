                     ...
                     <div class="holderCircle">
                        ...
                        <div class="contentCircle">
                           ...
                           <div class="CirItem title-box CirItem2">
                              <h2 class="title"><span>Comunidade </span></h2>
                              <p>Você nunca verá nada igual, fora daqui. Somos fãs de super-herois, programadores Nerds e apaixonados par mangás e cultura POP.</p>
                              <i class="fa fa-comments"></i>
                           </div>
                           <div class="CirItem title-box CirItem3">
                              <h2 class="title"><span>Avatares</span></h2>
                              <p>Crie avatares para jogar RPG, entar em clãs, grupos e muitas outras opções.</p>
                              <i class="fa fa-user"></i>
                           </div>
                           <div class="CirItem title-box CirItem4">
                              <h2 class="title"><span>Produtos</span></h2>
                              <p>Produtos personalizados ao seu gosto sobre os personagens que ama.</p>
                              <i class="fa fa-tags"></i>
                           </div>
                           <div class="CirItem title-box CirItem5">
                              <h2 class="title"><span>Compartilhe</span></h2>
                              <p>Você pode colaborar com o crescimento da comunidade</p>
                              <i class="fa fa-upload"></i>
                           </div>
